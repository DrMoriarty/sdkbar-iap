    ...
    public void launchPurchaseFlow(Activity act, String sku, String itemType, List<String> oldPurchasedSkus,
        ...
        try {
            ...
            if (oldPurchasedSkus == null || oldPurchasedSkus.isEmpty()) {
                ...
                params.putBoolean("replaceSkusProration", true);
                params.putStringArrayList("skusToReplace", new ArrayList<String>(oldPurchasedSkus));
                buyIntentBundle = mService.getBuyIntentExtraParams(5, mContext.getPackageName(), sku, itemType, extraData, params);
                */
            }
